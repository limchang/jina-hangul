...
// 자음 + ㅏ 조합 (가~하)
// 캔버스: 1000 × 500 (정사각형 2개 이어붙임)
// 왼쪽 500×500: 자음 (기존 좌표 그대로)
// 오른쪽 500×500: ㅏ (기존 모음 ㅏ 좌표 + x오프셋 500)
const SYL_A = [
  {path:'M 750 130 L 750 370'},  // ㅏ 세로 (250+500)
  {path:'M 750 250 L 830 250'}   // ㅏ 가로 (250+500, 330+500)
];
