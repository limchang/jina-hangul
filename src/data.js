...
export const CONSONANTS = [
  ...
  { char:'ㅈ', strokes:[{path:'M 150 150 L 350 150'}, {path:'M 250 150 Q 210 240 160 360'}, {path:'M 250 150 Q 290 240 340 360'}] },
  { char:'ㅊ', strokes:[{path:'M 250 90 L 250 140'}, {path:'M 150 150 L 350 150'}, {path:'M 250 150 Q 210 240 160 360'}, {path:'M 250 150 Q 290 240 340 360'}] },
